...
#neue Variable, die nur Stunden anzeigt (einfache Variante von oben)
wildschwein_crop_overlay$time <- 
  hour(wildschwein_crop_overlay$DatetimeUTC)
...
wildschwein_crop_overlay <- wildschwein_crop_overlay %>%
  add_count(Frucht)  #fügt neue Spalte ein, die jeweilige Gesamt-Zahl enthält
...
ggplot(wildschwein_crop_overlay, aes(x = time)) +
  geom_bar() + 
